...
public abstract class EntitiesShapesTestsBase extends EntitiesTestsBase {
	...
	protected static final I18nProperty ERROR_SIDES_ARE_NULL = Messages.Error.SIDES_ARE_NULL;
	protected static final I18nProperty ERROR_SIDES_NOT_POSITIVE = Messages.Error.SIDES_NOT_POSITIVE;
	protected static final I18nProperty ERROR_TRIANGLE_RULE = Messages.Error.TRIANGLE_RULE;
	protected static final I18nProperty TO_STRING_SHAPE = Messages.ToString.SHAPE;
