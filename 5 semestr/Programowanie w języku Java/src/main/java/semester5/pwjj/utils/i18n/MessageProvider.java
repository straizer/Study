...
public class MessageProvider {
	 ...
	 */
	private final Path I18N_PATH = Paths.get("i18n", "Messages");
	 ...
	 */
	public String get(final I18nProperty i18nProperty) {
	 ...
	 */
	public String get(final I18nProperty i18nProperty, final Locale locale) {
		final String messageName = i18nProperty.getPropertyName();
	 ...
	 */
	private String handleMissingResourceException(final I18nProperty i18nProperty, final Locale locale) {
		final String messageName = i18nProperty.getPropertyName();
